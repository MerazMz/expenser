...
export default function SettingsPage() {
  ...
  const handleSaveBudget = async () => {
    ...
    setIsLoading(true);
    try {
      const updated = await saveSettings({ monthlyBudget: Number(budget) });
      setSettings(updated);
  ...
  const handleExport = async () => {
    ...
    const expenses = await getMonthExpenses(currentMonth);
            ...
            <CardContent className="p-4 space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <p className="text-sm font-medium italic text-foreground">Monthly Budget</p>
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] uppercase font-medium opacity-70">Monthly summary sheet</p>
              </div>
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] uppercase font-medium opacity-70">Regenerate all daily entries</p>
              </div>
              <ChevronRight className="ml-auto h-4 w-4 opacity-30" />
            </Button>
          </div>
