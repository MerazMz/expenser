...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const isAndroidWebView = /Android.*Version\/[0-9.]+/i.test(ua) || ua.includes('wv');
        ...
        return (
          ...
          >
            <div className="text-center space-y-4">
              <h1 className="text-6xl font-black italic tracking-tighter text-[#c8f135]">expenser</h1>
              <p className="text-[10px] font-medium tracking-widest text-muted-foreground/60 lowercase">Personal Finance Redefined</p>
            </div>
